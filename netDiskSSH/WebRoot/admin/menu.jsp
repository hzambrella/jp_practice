	      ...
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            ...
	            <li><a href='<%=path %>/wenjianMana.action' target='main'>文件信息管理</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b>公告信息管理</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	  ...
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      <dl class='bitem'>
	        ...
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/userinfo/yezhuPw.jsp' target='main'>修改个人密码</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b>日常管理模块</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/admin/tousu/tousuAdd.jsp' target='main'>我要在线投诉</a> </li>
	            <li><a href='<%=path %>/tousu?type=tousuMine' target='main'>我的投诉信息</a> </li>
	            <li><a href='<%=path %>/admin/baoxiu/baoxiuAdd.jsp' target='main'>我要在线报修</a> </li>
	            <li><a href='<%=path %>/baoxiu?type=baoxiuMine' target='main'>我的报修信息</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
