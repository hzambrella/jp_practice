	...
	<table width='99%' height="100%" border='0' cellspacing='0' cellpadding='0'>
	  <tr>
	    <td style='padding-left:3px;padding-top:8px' valign="top">
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b>修改我的信息</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/auser/userinfo/userinfo.jsp' target='main'>修改我的信息</a> </li>
	          </ul>
	        </dd>
	      </dl>
	      <dl class='bitem'>
	        <dt onClick='showHide("items1_1")'><b>文件夹---管理</b></dt>
	        <dd style='display:block' class='sitem' id='items1_1'>
	          <ul class='sitemu'>
	            <li><a href='<%=path %>/catelogMine.action' target='main'>文件夹---管理</a> </li>
	            <li><a href='<%=path %>/auser/catelog/catelogAdd.jsp' target='main'>文件夹---新建</a> </li>
	          </ul>
	        </dd>
	      </dl>
		  </td>
